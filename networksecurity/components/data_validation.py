...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe:pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"Required number of cols - {number_of_cols}")
            logging.info(f"Number of cols in dataframe - {len(dataframe.columns)}")
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            ## read data from train and test set
